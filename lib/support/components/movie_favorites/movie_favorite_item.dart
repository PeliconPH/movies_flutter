...
abstract class MovieFavoriteItemViewModelProtocol {
  int get movieId;
...
class MovieFavoriteItem extends StatelessWidget {
  final MovieFavoriteItemViewModelProtocol viewModel;
  const MovieFavoriteItem({super.key, required this.viewModel});
